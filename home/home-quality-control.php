...
foreach ($users as $user) {
    ...
    $nationalIdImage = '';
    if(isset($user['nationalIdUrl'])) {
        $nationalIdImage = '<img width="100" src="/egyway' . $user['nationalIdUrl'] . '" />';
    }

    $pictureUrlImage = '';
    if(isset($user['pictureUrl'])) {
        $pictureUrlImage = '<img width="100" src="/egyway' . $user['pictureUrl'] . '" />';
    }
    $usersResult .= '<tr>' .
        '<td>' . $user['id'] . '</td>' .
        '<td>' . $user['name'] . '</td>' .
        ...
        '<td>' . $user['email'] . '</td>' .
        '<td>' . $user['role'] . '</td>' .
        '<td>' . $nationalIdImage . '</td>' .
        '<td>' . $pictureUrlImage . '</td>' .
        '<td>' .
