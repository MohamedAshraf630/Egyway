...
<div class="container mt-5 p-5">
	<div class="card">
		<div class="card-body">
			<h2 class="text-center">Welcome to EgyWAY</h2>
			<?php
			if ($error == 'invalid') {
			...
			?>
			<form autocomplete="off" method="POST" action="services/login-service.php" id="login-frm">
				...
				<div class="form-group">
					...
					<small><a href="/egyway/signup.php" id="new_account">Create New Account</a></small>
				</div>
